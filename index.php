            ...
            <div class="row">
                <div>
                    <nav-tabs class="nav-pills">
                        <a href="#section_presentation"></a>
                        <a href="#section_Apropo">Á propos</a>
                        <a href="#section_projet">Projet</a>
                        <a href="section_draw">Réalisations</a>
...
<main>
    ...
    <section id="section_presentation" class="d-flex align-items-center" hidden="hidden">
        <div class="container-fluid">
            <div class="row">
    ...
    <section id="section_Apropo" hidden="hidden">
        <div class="container-fluid">
            <div class="row">
    ...
    <section id="section_projet" class="sct-projets" hidden="hidden">
        <div class="container-fluid">
    ...
    <section id="section_draw" hidden="hidden">
        <div class="container.fluid">
            <!-- block5 draw Chalice -->
            <div class="row">
    ...
    <!-- section competence -->
    <section id="section_competence" class="sct-competences" hidden="hidden">
        <div class="container-fluid">
            <div class="row">
    ...
    <!-- section contact -->
    <section id="section_contact" class="sct-contact" hidden="hidden">
        <div class="container-fluid">
            <div class="row">
